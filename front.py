...
label1=Label(window,text="HOTEL de van Rossum")
...
label5=Label(window,text="Number of days of stay:")
label5.grid(row=4,column=0)

label6=Label(window,text="Room Type(Normal , king, Delux) :")
...
b6=Button(window,text="Clear",width=12,command=clear_text)
